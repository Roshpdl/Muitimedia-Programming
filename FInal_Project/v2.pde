...
//// visualisation, which can lead to very abrupt changes. As we decrease the
...
////For Rasterization
//PImage img;
//int pixpos; //pixel location

//void setup()
//{
//  //For rasterization
//  size(1000, 1000, P3D);
//  img = loadImage("bugatti.jpeg");
...
//  //sphereDetail(3);
//  float num_tiles = map(mouseX, 0, width, 20, 300); //You can also use mouse x or mouse y to determine the number of tiles
...
//  rotateY(radians(frameCount)+rms_scaled*0.0001);
